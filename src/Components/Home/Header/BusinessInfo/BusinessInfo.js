            ...
            <div className="container text-white">
                <div className="row">
                    <div className="col-md-7 my-5">
                        <h5 className='text-primary py-3'>Repair Master</h5>
                        <h3 className='py-2 h2'>Expert repairs. done fast</h3>
                        <p className='py-2'>Fast, Affordable Tablet, Laptop, Game Console and Cell Phone Repair. Your gadgets play a major role in your professional, personal and school life. When your phone, tablet, or laptop breaks you want an expert to handle the repair. That’s where we come in. With over a decade of experience in the electronics repair industry, <span className='text-primary'>repairMaster</span> can get the job done quickly and effectively.</p>
                        <button className='btn button text-white p-2'>WHO WE ARE</button>
                    </div>
                    <div className="col-md-5 business-info card p-4 text-dark my-5">
                        <h6 className='py-2'>WHY CHOOSE US ?</h6>
