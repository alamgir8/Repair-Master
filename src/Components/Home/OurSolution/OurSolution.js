                ...
                <div className="our-solution py-3 px-2">
                    <div className="row">
                        <div className="col-md-5 py-3">
                            ...
                            <p>Every <span>Repair</span> Master technician goes through an intensive training process, and we maintain an environment of constant learning, so no device is too new, no technology too complicated.</p>
